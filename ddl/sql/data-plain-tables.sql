...
INSERT INTO Comment_replyOf_Message
SELECT CommentId, replyOf_PostId
FROM Comment
WHERE replyOf_PostId IS NOT NULL
UNION ALL
SELECT CommentId, replyOf_CommentId
FROM Comment
WHERE replyOf_CommentId IS NOT NULL;

INSERT INTO Message_hasCreator_Person
SELECT CommentId, hasCreator_PersonId
FROM Comment
UNION ALL
SELECT PostId, hasCreator_PersonId
FROM Post;

INSERT INTO Message_hasTag_Tag
SELECT CommentId, TagId
FROM Comment_hasTag_Tag
UNION ALL
SELECT PostId, TagId
FROM Post_hasTag_Tag;

INSERT INTO Message_isLocatedIn_Country
SELECT CommentId, isLocatedIn_CountryId
FROM Comment
UNION ALL
SELECT PostId, isLocatedIn_CountryId
FROM Post;
